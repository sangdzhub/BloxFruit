...
v0.new("<Color=Cyan>Welcome to sangdzhub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(92771879925313) ;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "sangdzhub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=92771879925313&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
...
-- Fixed: Logo Toggle Button (always visible)
local player = game:GetService("Players").LocalPlayer
local logoGui = Instance.new("ScreenGui")
logoGui.Name = "ToggleLogoGUI"
...
toggleButton.Image = "rbxassetid://84569734665800"
toggleButton.Parent = logoGui
...
-- Toggle the visibility of the Main UI frame
toggleButton.MouseButton1Click:Connect(function()
	local anchorGui = game.CoreGui:FindFirstChild("Anchor")
	if anchorGui and anchorGui:FindFirstChild("Main") then
		local mainFrame = anchorGui:FindFirstChild("Main")
