...
logoButton.Parent = v141 -- v141 là ScreenGui chứa Main GUI
...
-- Toggle hiện/ẩn GUI chính
logoButton.MouseButton1Click:Connect(function()
	v141.Enabled = not v141.Enabled -- Toggle GUI chứa Main
end)
